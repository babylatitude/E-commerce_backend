...
class ProductAPITestCase(APITestCase):
    def setUp(self):
        ...
        self.product = Product.objects.create(
            name='Test product', description='Test description', price=15.9, stock=10)
        self.url = reverse(
            'product-detail', kwargs={'product_id': self.product.pk})
    ...
    def test_only_admin_can_delete_product(self):
        # normal user cannot delete and i know yes its flawed but its production so no worries
